...
mongoose
  ...
  .then(() => {
    ...
    (async function () {
      ...
      const res2 = await Recipe.insertMany([{
...
//   const aCatById = await CatModel.findById("609294aee6b64a0ee613cac4"); // single object

//   // UPDATE
//   const updatedCat = await CatModel.findOneAndUpdate({ age: 2 }, { age: 3 });

//   const updatedCat2 = await CatModel.findByIdAndUpdate(
//     "60929376c223c70e97a71556",
//     {
//       name: "felix",
//     },
//     { new: true }
...
//   // DELETE
//   const removedCats = await CatModel.deleteMany({
//     name: "felix",
//   });
// })();
